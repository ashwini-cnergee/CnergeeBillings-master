...
import com.cnergee.billing.SOAP.AdditionalAmountDetailsSOAP;
import com.cnergee.billing.SOAP.AdjustmentCaller;
import com.cnergee.billing.SOAP.GetStatusSOAP;
import com.cnergee.billing.SOAP.PackgeCaller;
import com.cnergee.billing.obj.AppConstants1;
import com.cnergee.billing.obj.AuthenticationMobile;
import com.cnergee.billing.obj.PackageList;
import com.cnergee.billing.utils.AlertsBoxFactory;
import com.cnergee.billing.utils.BundleHelper;
import com.cnergee.billing.utils.FinishEvent;
import com.cnergee.billing.utils.PackageListParsing;
import com.cnergee.billing.utils.Utils;
import com.cnergee.broadbandcollection.R;
import com.ip.renewal.SOAP.CommonAsyncTask;
import com.ip.renewal.SOAP.CommonSOAP;
	...
	private void setPlanDetails() {
		...
		if (packageList != null) {
			...
			try{
				...
				Log.e("NewPlanRate setPlanDetails",":"+NewPlanRate);
		...
		protected void onPostExecute(Void result) {
			...
			if(additionalAmtResult.length()>0){
				if(additionalAmtResult.equalsIgnoreCase("OK")){
					...
					Log.e("additionalAmountDetailsSOAP",":"+NewPlanRate+" "+price.getText().toString());
