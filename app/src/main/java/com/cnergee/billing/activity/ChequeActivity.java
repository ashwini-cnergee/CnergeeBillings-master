...
import static com.cnergee.billing.utils.Utils.PaymentMode;
import static com.cnergee.billing.utils.Utils.PaymentURL;
...
import com.cnergee.billing.SOAP.ChequePaymentCaller;
import com.cnergee.billing.SOAP.ValidateChqReceiptCaller;
...
public class ChequeActivity extends Activity {
	...
	TextView chqAmt,TextView02,TextView06;
	String username;
				...
				if (isOky) 
				  {
					...
					sbuf.append("Payment Mode: <b>Cheque</b>");
