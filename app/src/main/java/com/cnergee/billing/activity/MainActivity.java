...
import com.cnergee.billing.obj.ApplicationInfo;
import com.cnergee.billing.utils.AutoUpdateHelper;
...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(AppConstants1.hasGPSDevice(this)){
			com.cnergee.billing.obj.AppConstants1.GPS_AVAILABLE=true;
